...
%%%%%%%%%%%%%%%%%%% THE CHAPTERS %%%%%%%%%%%%%%%%%%%%
\input{elprograma.tex}                              % 1er Capítulo
\input{instalacion.tex}                             % 2do Capítulo
\input{fichentrada.tex}                             % 3er Capítulo
\input{modulos.tex}                                 % 4o Capítulo
\input{utilidades.tex}                              % 5o Capítulo
\input{lpvisual.tex}                                % 6o Capítulo
\input{ejemplos.tex}                                % 7o Capítulo
%\input{desmodulos.tex}                             % 8o Capítulo
%\input{paralelizacion.tex}                         % 9o Capítulo
\input{gente.tex}                                   % 10o Capítulo
\input{apendice.tex}                                % 11o Capítulo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
