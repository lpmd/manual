...
\begin{tabular}{lcl}
 ...
 coords & = & utilizado para ``posicionar'' una celda que \\
           ...
           &&centered/uncentered.\\
 inside & = & Puede ser true/false, indica si los \'atomos. \\
          &&que est\'an fuera de una celda se deben reubicar.\\
 external & = & ignore/consider. Espec\'ifica si se deben \\
          &&ignorar o considerar los atomos fuera de la celda.
\end{tabular}
}
