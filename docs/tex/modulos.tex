...
Los visualizadores ordinarios antes de pasar a \verb|lpvisual|, el gran visualizador.
...
Es un proyecto independiente, desarrollado por Felipe Gonz\'ales y Sergio Davis, en el cu\'al se logra visualizar en tiempo real, las posiciones at\'omicas de la simulaci\'on. Hasta el momento se encuentra en etapa de desarrollo, pero ya ha mostrado resultados muy interesantes como se puede observar en la figura
