...
\begin{itemize}
 \item Version 0.5 : Lanzada 4 de Abril 2008.
 \item Version 0.4 : Lanzada Julio 2007.
\end{itemize}
...
\cajatx{Nota : Los que poseen la versi\'on inestable cuentan con el fichero \textbf{autogen.sh} para poder generar los Makefiles. \\ Se necesita instalar automake y libtool para poder ejecutar \textbf{autogen.sh}.}
...
En primer lugar descomprima el pqeute de la \textbf{liblpmd},
...
%\cajatx{Sin embargo, la versi\'on de prueba 0.4.X presentaba problemas con tabulaciones en un fichero de entrada, por lo que se recomienda evitarlo o bien chequear que la salida entregue las posiciones correctas.}
...
Se utilizan los 3 vectores bases, poni\'endolos de la siguiente manera en el fichero
...
A diferencia con el m\'etodo anterior, este m\'etodo no requiere de un fichero con posiciones at\'omicas, en lugar de ello se requiere un m\'odulo que genera automaticamente una celda con atomos, segun los requerimientos propios del m\'odulo. Por ejemplo existen m\'odulos actualmente para genrar celdas del tipo \textbf{sc}, \textbf{bcc}, \textbf{fcc} y el m\'etodo \textbf{skewstart}.

\end{itemize}

Las forma general de la orden \verb|input| requiere de los siguientes argumentos para un funcionamiento adecuado. Para ver m\'as informaci\'on sobre el m\'odulo revise la secci\'on 3.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{M\'odulos : Potenciales Interat\'omicos de pares}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{M\'odulos : Potenciales Interat\'omicos Met\'alicos}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{M\'odulos : Potenciales Interat\'omicos Nulos}
