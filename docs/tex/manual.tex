...
\usepackage[colorlinks]{hyperref} %internal links
\usepackage{makeidx} %makes an index (you must use "makeindex" program first)
\usepackage[left=2.2cm,right=1.7cm,top=2.3cm,bottom=2.1cm]{geometry} % Specify page margins
\makeindex
...
\newcommand{\fb}[1]{\framebox[1.1\width]{#1}}
