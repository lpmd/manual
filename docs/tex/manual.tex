...
Las posibles formas de ingresar una descripcion de la llamada \verb|cell| pueden ser entregadas como argumentos en la ejecuci\'on de \lpmd y no necesitan estar necesariamente dentro del fichero de \textbf{control}, lo que ayuda a la creaci\'on de scrtips.
...
La forma general de la orden \verb|input| requiere de argumentos para un funcionamiento adecuado. Para ver m\'as informaci\'on sobre el m\'odulo revise la secci\'on ~\ref{chap:modulos}. Estos son ejemplos de algunos argumentos:
...
En \'este aso solo tenemos periodicidad en el eje \verb|z|.
...
Ac\'a se realizar\'a una simulaci\'on de 10000 pasos.
...
Cada cuantos pasos la simulaci\'on muestra las propiedades globales. Estas propiedades, pueden ser asignadas por el mismo usuario, haciendo la salida lo m\'as configurables seg\'un los requrimientos propios.
